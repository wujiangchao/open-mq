...
package com.open.openmq.broker.out;

import com.open.openmq.broker.exception.NamesrvNotFoundException;
...
import com.open.openmq.client.impl.consumer.PullResultExt;
...
import com.open.openmq.common.message.MessageBatch;
...
import com.open.openmq.common.namesrv.DefaultTopAddressing;
import com.open.openmq.common.namesrv.RegisterBrokerResult;
import com.open.openmq.common.namesrv.TopAddressing;
...
import com.open.openmq.common.protocol.body.ClusterInfo;
import com.open.openmq.common.protocol.body.GetBrokerMemberGroupResponseBody;
import com.open.openmq.common.protocol.body.KVTable;
import com.open.openmq.common.protocol.body.LockBatchRequestBody;
import com.open.openmq.common.protocol.body.LockBatchResponseBody;
...
import com.open.openmq.common.protocol.header.GetBrokerMemberGroupRequestHeader;
...
import com.open.openmq.common.protocol.header.SendMessageRequestHeaderV2;
...
import com.open.openmq.common.rpc.ClientMetadata;
import com.open.openmq.common.rpc.RpcClient;
import com.open.openmq.common.rpchook.DynamicalExtFieldRPCHook;
...
import com.open.openmq.remoting.InvokeCallback;
...
import com.open.openmq.remoting.protocol.RemotingSerializable;
...
//    }
    ...
    public List<RegisterBrokerResult> registerBrokerAll(
        ...
        if (nameServerAddressList != null && nameServerAddressList.size() > 0) {
            ...
            throw new NamesrvNotFoundException(brokerAddr);
        }
